...
export const COMMON_ERROR_CODE = {
  ...
  manMachineError: 1012, // 人机验证错误
  captchaExpired: 1013, // 验证码已过期
};
...
export const REDIS_KEY = {
  ...
  dbUserHistoryMsgList: `${REDIS_KEY_PREFIX}dbUserHistoryMsgList___`, // 用户间历史消息
};
...
export const IM_REDIS_KEY = {
  ...
  // chat
  chatRoomUserList: `${IM_REDIS_KEY_PREFIX}chatRoomUserList___`,
  chatRoomClusterInfo: `${IM_REDIS_KEY_PREFIX}chatRoomClusterInfo___`,
};
